...
/* To connect to the database, you need to use a JDBC url with the following 
   ...
   jdbc:mysql://fdb15.freehostingeu.com:3306/2173668_libzap[?param1=value1][&param2=value2]... 
...
String query = "SELECT id, usuario, password FROM usuarios";

// Get the query results and display them.
ResultSet sqlResult = sqlStatement.executeQuery(query);
while(sqlResult.next()) {
uId = sqlResult.getString("id");
fName = sqlResult.getString("usuario");
lName = sqlResult.getString("password");
